  ...
  },
  {
    ...
    opts = function(_, opts)
      ...
      opts.statusline = {
        ...
        hl = { fg = "fg", bg = "bg" },
        -- each element self:ollowing is a component in astroui.status module
...

        {
          ...
          status.component.file_info {
            ...
            surround = {
              separator = "right",
              color = { main = "file_info_bg", right = "file_info_bg", left = "file_info_bg" },
              condition = false,
            },
          },
        },
        ...
        { -- make nav section with icon border
          ...
          status.component.builder {
            ...
            surround = {
              separator = { "", "" },
              color = { main = "nav_icon_bg", left = "file_info_bg", right = "file_info_bg" },
            },
          },
          ...
          status.component.nav {
            ...
            scrollbar = { padding = { right = 1 } },
            ruler = { padding = { right = 1, left = 1 } },
            -- disable all other providers
            -- use no separator and define the background color
            surround = {
              separator = "right",
              color = { main = "file_info_bg", left = "file_info_bg", right = "file_info_bg" },
              padding = { right = 1, left = 1 },
            },
          },
        },
